...
def hull_method(pointlist):
    hull = Hull(pointlist)
    return [[p.x, p.y] for p in hull.hull]

t1 = sorted(hull_method([[0, 0], [5, 3], [0, 5]]))
print('t1: ', t1 == [[0, 0], [0, 5], [5, 3]], f'[{t1}]')
t2 = sorted(hull_method([[0, 0], [5, 3], [0, 5], [0, 3], [2, 3], [5, 3]]))
print('t2: ', t2 == [[0, 0], [0, 5], [5, 3]], f'[{t2}]')